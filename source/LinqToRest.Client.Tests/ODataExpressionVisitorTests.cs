...
namespace LinqToRest.Client.Tests
{
	...
	public class ODataExpressionVisitorTests
	{
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => s.TestString == "hello" && s.TestString.Length < 4);
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => s.TestString == "hello");
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => s.TestInt < 4);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestInt + 4);
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => !s.TestBoolean);
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => s.TestString == null);
		...
		public void Translate_TypeBinaryExpression_TranslatesCorrectly()
		{
			...
			Assert.That(oDataExpression, Is.EqualTo("isof(TestInt, Int32)"));
		}
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestString.ToUpper());
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestString.ToUpperInvariant());
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestString.ToLower());
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestString.ToLowerInvariant());
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestString.Trim());
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestString.Length);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestDateTime.Year);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestDateTime.Month);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestDateTime.Day);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestDateTime.Hour);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestDateTime.Minute);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestDateTime.Second);
		...
		{
			var oDataExpression = BuildTranslatedExpression<int>(s => s.TestString.IndexOf("hello"));
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => s.TestString.StartsWith("hello"));
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => s.TestString.EndsWith("hello"));
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestString.Substring(2));
		...
		{
			var oDataExpression = BuildTranslatedExpression<bool>(s => s.TestString.Contains("hello"));
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestString.Replace("hello", "world"));
		...
		{
			var oDataExpression = BuildTranslatedExpression<string>(s => s.TestChild.TestString);
