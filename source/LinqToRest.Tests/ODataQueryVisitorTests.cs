...
namespace LinqToRest.Tests
{
	...
	public class ODataQueryVisitorTests
	{
		...
		{
			var left = ODataQueryFilterExpression.MemberAccess("TestInt");
			var right = ODataQueryFilterExpression.Constant(3);

			var filterExpression = ODataQueryFilterExpression.Binary(left, ODataQueryFilterExpressionOperator.Equal, right);
